...
**Pendências concluídas na versão 1.2.3**
...
As correções compõem a versão 1.2.3. O executável instalado recebe as mudanças depois que o pipeline concluir e a release for publicada. Nenhum banco do usuário foi modificado durante a revisão.
